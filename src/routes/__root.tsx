...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Verified GNDEC notices, timetables, hiring updates and more — in one calm feed." },
...
function RootShell({ children }: { children: ReactNode }) {
  // Run before hydration so the initial paint already matches the OS theme.
